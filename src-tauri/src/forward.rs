...
#[tauri::command]
pub async fn forward_mail(host: Option<String>, port: Option<String>, username: Option<String>, password: Option<String>, email_content: Option<String>, email_to: Option<String>, email_subject: Option<String>) {
	...
	if username == "" { username = "samir@mail-dev.com".to_string(); }
	if email_to == "" { email_to = "email@example.com".to_string(); }
