		...
		return (
			<div className="flex h-full">
				...
				{this.props.mailIndex !== null ? <div className="h-full bg-gray-50 w-full px-6 py-3 scroll overflow-y-auto">
					...
					<div className="border rounded-md bg-white whitespace-pre-wrap p-4 text-sm font-sans text-gray-600 mb-4">
					...
					{this.props.mail.attachments.length > 0 && <div className="border rounded-md bg-white whitespace-pre-wrap p-2 text-sm font-sans text-gray-600">
						{this.props.mail.attachments.map((attachment, key) => {
							return <div key={key} onClick={() => this.saveAttachment(attachment)} className="flex items-center cursor-pointer text-gray-500 hover:text-gray-900">
