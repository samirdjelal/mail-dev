...
class Sidebar extends Component {
	render() {
		return (
			<div className="w-20 bg-gray-300 bg-opacity-40 flex-shrink-0 flex flex-col items-center pt-2 border-r border-gray-300 border-opacity-70">
				<Link to="/mailbox">
					<div className={`relative mb-4 py-1 cursor-pointer hover:opacity-90 rounded ${this.props.history.location.pathname === '/mailbox' ? 'text-gray-100 bg-gray-700 shadow-inner' : 'text-gray-600'}`}>
						...
						<div className="w-16 h-10 flex justify-center items-center">
							<svg className="w-10 h-8 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
						...
						<div className="text-xs uppercase font-semibold text-center select-none">Mailbox</div>
					</div>
				</Link>
				
				<Link to="/settings">
					<div className={`relative mb-4 py-1 cursor-pointer hover:opacity-90 rounded ${this.props.history.location.pathname === '/settings' ? 'text-gray-100 bg-gray-700 shadow-inner' : 'text-gray-600'}`}>
						...
						<div className="w-16 h-10 flex justify-center items-center">
							<svg className="w-10 h-8 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
						...
						<div className="text-xs uppercase font-semibold text-center select-none">Settings</div>
					</div>
				</Link>
